            ...
            message.channel.awaitMessages(filterMessage, { max: 1, time: 30000, errors: ['time'] })
                .then(collected => {
                    ...
                    if(attachment) {
                        ...
                        let yesyesembed = new MessageEmbed().setTitle("menprotect").setDescription("Obfuscating...").setColor(Colors.lightblue)
                        msg.edit(yesyesembed).then(lmao => {
                            ...
                            setTimeout(() => {
                                ...
                                lmao.edit(new MessageEmbed().setTitle("menprotect").setDescription("Done!").setColor(Colors.lightblue))
                            }, 5000);
